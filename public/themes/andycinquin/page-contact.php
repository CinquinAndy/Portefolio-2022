...
<div class="flex relative justify-center items-center w-screen h-screen">
    <div class="grid absolute top-0 left-0 z-30 grid-cols-8 px-20 w-full ">
        <form action="#" method="post" class="xl:col-start-3 col-span-8 xl:col-span-4 mt-[20vh] xl:mt-[15vh] grid grid-cols-3 xl:grid-cols-6 gap-10">
            <?php wp_nonce_field( 'envoyer-message', 'message-verif' ) ?>
            <div class="flex flex-col col-span-3 xl:col-span-6 gap-4">
                <h1 class="z-20 text-6xl font-bold tracking-widest uppercase xl:text-6xl">CONTACT</h1>
            </div>
            <div class="flex flex-col col-span-3 gap-4">
                <label for="name" class="xl:text-sm text-xl">Nom et prénom</label>
                <input type="text" name="name" id="name" class="text-xl xl:text-base border-0 bg-slate-1000 xl:h-[50px] h-[100px]">
            </div>
            <div class="flex flex-col col-span-3 gap-4">
                <label for="email" class="xl:text-sm text-xl">Email</label>
                <input type="email" name="email" id="email" class="text-xl xl:text-base border-0 bg-slate-1000 xl:h-[50px] h-[100px]">
            </div>
            <div class="flex flex-col col-span-3 gap-4">
                <label for="phone" class="xl:text-sm text-xl">Téléphone</label>
                <input type="text" name="phone" id="phone" class="text-xl xl:text-base border-0 bg-slate-1000 xl:h-[50px] h-[100px]">
            </div>
            <div class="flex flex-col col-span-3 gap-4">
                <label for="company" class="xl:text-sm text-xl">Société (Facultatif)</label>
                <input type="text" name="company" id="company" class="text-xl xl:text-base border-0 bg-slate-1000 xl:h-[50px] h-[100px]">
            </div>
            <input type="hidden" name="raison">
            <div class="flex flex-col col-span-3 xl:col-span-6 gap-4">
                <label for="message" class="xl:text-sm text-xl">Message</label>
                <textarea rows="6" name="message" id="message" class="text-xl xl:text-base border-0 bg-slate-1000"></textarea>
                <p class="xl:text-xs text-lg  italic">Lors de la validation de ce formulaire, vous consentez à ce que les données soumises soient collectées et stockées en vue d'être utilisées pour traiter votre demande de contact.</p>
                ...
                <div class="flex justify-end items-end mt-4">
                    <input type="submit"
                           class="px-16 hover:cursor-pointer py-8 xl:text-sm text-xl bg-indigo-600 rounded xl:px-20 xl:py-4"
    ...
    <div class="z-20 text-7xl font-light font-semibold tracking-widest uppercase xl:text-8xl"></div>
    ...
    <!--    MEDIA -->
    <div class="hidden xl:flex absolute right-0 bottom-0 z-30 flex-col gap-16 justify-evenly items-center p-10 mb-32 xl:p-20 xl:gap-10 xl:mb-0">
        <!--        Facebook -->
    ...
    <div class="flex absolute bottom-0 left-0 justify-center items-center p-20 mb-24 xl:p-20 xl:mb-0">
        <h2 class="text-3xl tracking-wider opacity-20 origin-bottom-left -rotate-90 font-body xl:text-xl">‣ CONTACT</h2>
    </div>
</div>
<?php get_footer(); ?>
