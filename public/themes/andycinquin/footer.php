<?php if (!is_home()): ?>
    <footer class="mt-[150px] grid grid-cols-8 p-8 xl:p-20 gap-5">
        <div class="flex flex-col col-span-3 col-start-1 gap-5 text-sm xl:col-span-4 xl:col-start-2">
            <img src="<?= get_template_directory_uri() ?>/assets/Ressources/icons/logov2.svg" alt="Logo"
                 class="w-10 h-10">
            <a class="py-4 text-xl xl:text-base" href="mailto:cinquin.andy@gmail.com">cinquin.andy@gmail.com</a>
            <p class="text-xl xl:text-base">
        ...
        <div class="flex flex-col col-start-5 col-span-2 xl:col-span-1 gap-10">
            <h2 class="text-2xl xl:text-xl font-bold xl:font-normal">SITEMAP</h2>
            <a class="text-lg xl:text-sm" href="/mes-realisations">Mes projets</a>
            <a class="text-lg xl:text-sm" href="/contact">Contact</a>
        </div>
        <div class="flex flex-col col-start-7 col-span-2 xl:col-span-1 gap-10">
            <h2 class="text-2xl xl:text-xl font-bold xl:font-normal">légales</h2>
            <a class="text-lg xl:text-sm" href="/politique-de-confidentialite">Mentions légales</a>
            <a class="text-lg xl:text-sm" href="/politique-de-confidentialite">Politique de confidentialité</a>
        </div>
        <div class="flex col-span-8 xl:col-span-6 col-start-1 xl:col-start-2 justify-between mt-10 text-lg xl:text-xs">
            <div class="mr-10 xl:m-0">
