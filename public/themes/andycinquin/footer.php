    ...
    <footer class="<?= is_page('contact')?'mt-[50vh]':'mt-[100px]' ?> xl:mt-[150px] grid grid-cols-8 p-4 xl:p-20 gap-5">
        <div class="flex flex-col col-span-3 col-start-1 gap-5 text-xs xl:col-span-4 xl:col-start-2">
            <img src="<?= get_template_directory_uri() ?>/assets/Ressources/icons/logov2.svg" alt="Logo"
                 class="w-6 h-6">
            <a class="py-4 text-xs xl:text-base" href="mailto:cinquin.andy@gmail.com">cinquin.andy@gmail.com</a>
        ...
        <div class="flex flex-col col-start-7 col-span-2 xl:col-span-1 gap-10">
            <h2 class="text-sm xl:text-xl font-bold xl:font-normal">légales</h2>
            <a class="text-xs xl:text-sm" href="/politique-de-confidentialite">Mentions légales</a>
            <a class="text-xs xl:text-sm" href="/politique-de-confidentialite">Politique de confidentialité</a>
        </div>
        <div class="flex col-span-8 xl:col-span-6 col-start-1 xl:col-start-2 justify-between xl:mt-8 xl:mt-10 text-xs">
            ...
            <div class="flex gap-4">
                <!--    MEDIA ( REAPETED - CARE ! ) -->
                <div class="flex gap-4 xl:gap-10 justify-evenly items-center">
                    <!--        Facebook -->
                    <a class="text-indigo-50 hover:text-slate-50"
                       ...
                       rel="noopener nofollow noreferrer" target="_blank">
                        <svg class="w-4 h-4 xl:w-8 xl:h-8" viewBox="0 0 24 24" fill="currentColor">
                            <path
                    ...
                    <a class="text-indigo-50 hover:text-slate-50" href="https://www.malt.fr/profile/andycinquin"
                       rel="noopener nofollow noreferrer" target="_blank">
                        <svg class="w-4 h-4 xl:w-8 xl:h-8" viewBox="0 0 1000 1000" fill="currentColor">
