    ...
    <div
        ...
        <?php if (is_front_page()): ?>
            ...
            <a class="relative text-indigo-400" href="<?= esc_url($menu[0]->url) ?>" rel="noopener">
                ...
                <h2 class="text-5xl font-semibold uppercase"><?= $menu[0]->title ?></h2>
            </a>
            <a class="hover:text-indigo-400" href="<?= esc_url($menu[1]->url) ?>" rel="noopener">
                <h2 class="text-5xl font-semibold uppercase"><?= $menu[1]->title ?></h2>
            </a>
            <a class="hover:text-indigo-400" href="<?= esc_url($menu[2]->url) ?>" rel="noopener">
                <h2 class="text-5xl font-semibold uppercase"><?= $menu[2]->title ?></h2>
            </a>
